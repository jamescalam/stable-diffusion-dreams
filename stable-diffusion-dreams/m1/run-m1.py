...
def diffuse(
    ...
    image = (image['sample'] / 2 + 0.5).clamp(0, 1)  # FIX image -> image['sample']
...
def main(
        ...
        seeds=[243, 523],
        name = 'jungle', # name of this project, for the output directory
        rootdir = '../../dreams',
    ...
    # generators cannot be run on MPS
    init_a = torch.randn(
